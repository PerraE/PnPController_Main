...
#define D_AXIS_BIT bit(D_AXIS)
#define U_AXIS_BIT bit(U_AXIS)

#define AXES_BITMASK (X_AXIS_BIT|Y_AXIS_BIT|Z_AXIS_BIT|A_AXIS_BIT|B_AXIS_BIT|C_AXIS_BIT|D_AXIS_BIT|U_AXIS_BIT)
